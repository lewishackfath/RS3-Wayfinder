...
if (!$user) {
    page_header('Home');
    ?>
    <section class="hero journal-landing">
        <div class="journal-emblem">✦</div>
        <h1>Find your next RuneScape journey.</h1>
        <p class="muted">RS3 Wayfinder helps players follow progression paths based on their account, goals and playstyle.</p>
