...
if (!current_user()) {
    page_header('Home');
?>
<section class="hero codex-landing-page">
    <span class="codex-kicker">RS3 Wayfinder</span>
    <h1>Open your adventurer codex.</h1>
    <p class="muted">Track RuneScape journeys, profile progress, quest paths, boss drops and recommendations through a mystical player journal.</p>
...
?>
<div class="dashboard-codex-page">
    <div class="journal-page-heading"><span class="codex-kicker">Adventurer Journal</span><h1>Welcome, <?= e($user['global_name'] ?: $user['username']) ?></h1><p class="muted">Your Wayfinder codex records your RuneScape profile, journeys, discoveries and recommended next steps.</p></div>
